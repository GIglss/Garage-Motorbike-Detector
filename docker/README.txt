...
& sudo docker run -dit --name cool_camera -v ./detector:/home/detector --device /dev/gpiomem:/dev/gpiomem --device /dev/video0:/dev/video0 --restart unless-stopped bike_detector_tflite:latest
